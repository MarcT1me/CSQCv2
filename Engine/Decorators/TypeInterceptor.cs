...
public static class TypeInterceptor
{
    ...
    private static void CreateInterceptedConstructor(TypeBuilder typeBuilder, ConstructorInfo originalConstructor, FieldBuilder proxyField, Type originalType)
    {
    ...
    private static void CreateInterceptedMethod(TypeBuilder typeBuilder, MethodInfo originalMethod, FieldBuilder proxyField)
    {
